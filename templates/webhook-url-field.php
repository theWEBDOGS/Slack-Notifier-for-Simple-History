...
?>
        ...
        <p>
            <input id="<?php echo SimpleHistory_SlackNotifierDropin::SETTINGS_OPTION_PREFIX ?>webhook_url" type="url" class="regular-text ltr" placeholder="<?php esc_attr_e('https://hooks.slack.com/services/ABC123/B123456/O4j88fj33bbbbjjkkfssd', 'simple-history') ?>" name="<?php echo SimpleHistory_SlackNotifierDropin::SETTINGS_OPTION_PREFIX ?>webhook_url" value="<?php echo esc_attr($notifier_webhook_url) ?>" />
        </p>
        <p class="description">
